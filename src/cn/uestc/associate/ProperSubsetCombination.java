...
public class ProperSubsetCombination {
	...
	private static Set<Item> properSubset; // 真子集集合

	public static Set<Item> getProperSubset(int n, Set<String> itemSet)
	{
		String[] array = new String[itemSet.size()];
		ProperSubsetCombination.array = itemSet.toArray(array);
		properSubset = new HashSet<Item>();
